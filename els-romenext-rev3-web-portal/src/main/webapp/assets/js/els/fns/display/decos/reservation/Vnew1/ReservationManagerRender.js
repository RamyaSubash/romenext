...
function ReservationManagerRender() {
	...
	this.structureDiv = function() {
		...
		if (document.getElementById('reservation_list_id') == undefined || document.getElementById('reservation_list_id') == null) {
			...
			GlobalHTMLUtils.createAppendHTMLEntity('header', 'reservation_list_id' , 'panel-heading', 'visible', 'block', '', reservationManagerDecoView);
		}
		
		if (document.getElementById('reservation_inst_list') == undefined || document.getElementById('reservation_inst_list') == null) {
			
			GlobalHTMLUtils.createAppendHTMLEntity('header', 'reservation_inst_list' , 'panel-heading', 'visible', 'block', '', reservationManagerDecoView);
    ...
    this.initializeTypeBar = function() {
		    ...
		    inputs += "<td class='create_icon' onclick=\"ReservationNewUtils.createReservation(); \"><img  id='img_create' title='Create Reservation'   src='"+img_path+ "design_icons/create.png'></td></tr>";	    
...
//			create the subdivision for that node 		
			...
			if (document.getElementById('reservation_detail_'+uuid) == undefined || document.getElementById('reservation_detail_'+uuid) == null) {		
				GlobalHTMLUtils.createAppendHTMLEntity('div', 'reservation_detail_'+uuid , 'reservation_detail', 'visible', 'inline-block', '', bodyDiv);
			}
//			find the Name of Reservation 
	...
	this.updateState = function (){
		...
		NodeFctsUtils.createNode(listTypeIds[0], curThreshold );
