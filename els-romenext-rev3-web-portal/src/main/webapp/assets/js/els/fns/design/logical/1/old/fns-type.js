...
//    inputs += "<div id='typeName'><label>Type Selected: </label>"+nametype+"<input type='hidden' name='typename' value='"+nametype+"'/></div>";
    ...
    inputs += "<div id='typeName'><label>Type Selected: </label>"+typeName+"<input type='hidden' name='typeid' value='"+typeId+"'/><input type='hidden' name='typename' value='"+typeName+"'/></div>";
	...
	formFooter += "<input type='button' value='Cancel' class='btn btn-success btn-xs' onclick='(new DesignLogicalRenderer()).showTypePropertiesByTypeId(" + typeId + ");'></form>";
...
//		}
    	...
    	if (key == 'id') {
    		...
    		inputs += "<tr><th>"+key +":</th>";
    		inputs += "<td><input type='checkbox' name='isRoot' ";
    		if (value == true) {
    			inputs += "checked";
    		}
    		inputs += "></td></tr> ";    		
//			inputs += "<td><input type='radio' name='isRoot' value='true'";
//		    if (value == true) { inputs += "checked";};   inputs += ">true<br/>";
//		    inputs += "<input type='radio' name='isRoot' value='false'";
//		    if (value == false) { inputs += "checked";};  inputs += ">false</td></tr> ";
    	}
	});
...
//					    if (value == false) { inputs += "checked";};  inputs += ">false</form></td></tr> ";
	...
	formFooter += "<td><input type='button'  value='Cancel'     class='btn btn-primary btn-xs' onclick='(new DesignLogicalRenderer()).showTypePropertiesByTypeId(" + type.id + ")'></td></tr><table></form>";
	Form.innerHTML = formHeader + inputs + formFooter;
	(new DesignLogicalRenderer()).emptyAll();
	$('#typeForm').append(Form);
