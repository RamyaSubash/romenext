...
//TypePropertyUtils.displayTypeProperties = function(appendTo, type,
//		showTypeInfo, typeDisplayFunction, propertyDisplayFunction) {
//	// TypePropertyUtils.displayTypeProperties = function( type, showTypeInfo,
//	// typeDisplayFunction, propertyDisplayFunction ) {
...
//	}
//
//	// if (type.sysProperties.restrictionStatus) {
//	// inputs += "<tr><th>Restriction Status</th><td>" +
//	// type.sysProperties.restrictionStatus.value + "</td></tr>";
//	// }
//
...
//
//			var newInput = TypePropertyUtils.displayTypeProperty(value,
...
//	var footer = "";
//
//	footer = "<tr><td><input type='button' value='Add Properties' class='btn btn-primary btn-xs'    onclick='TypePropertyUtils.AddTypeProperties();'/></td>";
//	footer += "<td><input type='button' value='Update Type'    class='btn btn-primary btn-xs'    onclick='TypePropertyUtils.showUpdateType()'/></td></tr>";
//	footer += "</table>";
...
TypePropertyUtils.displayTypeProperty = function(property, displayFunction) {
	console.log("Inside  TypePropertyUtils.displayTypeProperty   ");
	var inputs = "";
	...
	if (displayFunction == null) {
		...
		if (property == null) {
			// inputs += "<tr><th colspan='2'> No properties added
			// </th></tr></table>";
		} else {
...
TypePropertyUtils.checkDuplicateTypeName = function(typeName) {
	var found = false;
...
TypePropertyUtils.AddTypeProperties = function() { // the selected name of the
													// type is saved in the
													// Global variable
	...
	inputs += "<div id='typeName'><label>Type Selected: </label>" + typeName
			...
			+ "'/></div>";
	inputs += "<button type='button' class='btn btn-success btn-xs'   onclick='TypePropertyUtils.addProperties()'>Add property</button>";

	formFooter = "<div id='propertiesFields'></div>";
	formFooter += "<input id='save_type_prop_button' type='button' value='Save properties'  class='btn btn-success btn-xs' onclick='TypePropertyUtils.saveTypeProperties(form)'>";
...
TypePropertyUtils.addProperties = function() {
...
TypePropertyUtils.showUpdateType = function() {
			...
			.each(
					...
					function(key, value) {
						...
						if (key == 'id') {
							...
							inputs += "<tr><th>"
									+ key
									+ ":</th><td><input type='text' name='isRoot'  value='true'/></td></tr>";
						}
					});
	...
	// button -->
	formFooter = "<tr><td><input type='button' value='Update Type' class='btn btn-primary btn-xs'   onclick='(new DesignLogicalRenderer()).saveUpdateTypeByGroup(form)' /></td>";
...
//TypePropertyUtils.saveTypeProperties = function(form) {
//
...
//		$('#console-log').append(
//				"<p style='color:red'>Error Type properties not saved: "
//						+ xhr.responseText);
//	};
//
