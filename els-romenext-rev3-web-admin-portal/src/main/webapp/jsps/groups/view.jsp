        ...
        <div class="row" id="main-content">
			        ...
			        <div class="login-wrap">  
			           ...
			           <%} %>
			              ...
			              <div class="input-group">
			                ...
			                <input type="text" class="form-control" placeholder="" name="edit_ip" value="  ${server.boxname }" disabled="disabled">
			             
			            </div> 
			            <div class="input-group">
							<span class="input-group-addon"><i class="fa fa-server" aria-hidden="true"></i>IP</span>
			                <input type="text" class="form-control" placeholder="" name="edit_ip" value="${server.ip }">
			                <span class="input-group-addon"><i class="icon_key_alt"></i>Port</span>
			                <input type="text" class="form-control" placeholder="3306" name="edit_port" value="${server.port }">
			            </div>
			            
			             <div class="input-group">
							<span class="input-group-addon"><i class="fa fa-server" aria-hidden="true"></i>Account Username</span>
			                <input type="text" class="form-control" placeholder="" name="edit_username" value="${server.username }">
			            ...
			            <button type="button" class="btn btn-primary btn-md" title="Cancel"><a href="/admin/dashboard" class="btn btn-default btn-flat">Cancel</a></button>
			...
			<!--             <button id="signupAdmin" class="btn btn-primary btn-md" type="submit">Signup</button> -->
			      ...
			      <div>
			      	  <table border=1>
						<tr> 
							<th>Name</th><th>Core Group</th><th>ip</th><th>Options</th>
						</tr> 
			      	  <c:forEach items="${ groups }" var="group" varStatus="counter">
							<tr>
								<td>${ group.groupname }</td><td>${group.host }</td><td>${group.id }</td>
																	<td>
