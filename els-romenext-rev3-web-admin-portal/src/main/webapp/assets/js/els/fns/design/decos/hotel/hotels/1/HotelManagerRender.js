	...
	this.initData = function() {
		...
		if( this.hotelType == null ) {
			$.each(typeMapViaId, function(key, value){
				...
				if( name === HotelManagerRender.DEFAULT_TYPE_HOTEL ) {
		...
		GlobalUtils.setGlobalTypeSelected( this.hotelType.id );
		
		// we should have all the hotel nodes
		// note: we treat the hotel's as the ENTRY NODE for this deco
		GlobalTypeInstanceUtils.getAllInstances( this.hotelType.id );
