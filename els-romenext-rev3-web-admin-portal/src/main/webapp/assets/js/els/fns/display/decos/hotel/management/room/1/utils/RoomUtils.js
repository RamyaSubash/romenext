function RoomUtils() {
	...
	RoomUtils.createHTMLEntity = function( elementType, elementId, className, visibility, display, innerHtml) {
	...
	RoomUtils.createAppendHTMLEntity = function( elementType, elementId, className, visibility, display, innerHtml, appendToDiv) {
...
//===================================================================================================================================
	RoomUtils.addDivsForARoomDetails = function( instHolderDiv , key ) {	
		/**
		...
		if( checkInstanceDiv == null || checkInstanceDiv.length == 0 ) {	
			RoomUtils.createAppendHTMLEntity('div', 'form_inst_'  + key, 'form_inst', 'hidden', 'none', '',  instHolderDiv);		
		...
		if( checkInstanceEditDiv == null || checkInstanceEditDiv.length == 0 ) {		
			RoomUtils.createAppendHTMLEntity('div', 'form_inst_edit_'  + key, 'form_inst_edit', 'hidden', 'none', '', instHolderDiv);		
		...
		if( checkInstanceChildDiv == null || checkInstanceChildDiv.length == 0 ) {	
			RoomUtils.createAppendHTMLEntity('div', 'form_inst_children_'  + key, 'form_inst_children', 'hidden', 'none', '', instHolderDiv);	
		...
		if( checkInstanceParDiv == null || checkInstanceParDiv.length == 0 ) {		
			RoomUtils.createAppendHTMLEntity('div', 'form_inst_parent_'  + key, 'form_inst_parent', 'hidden', 'none', '',  instHolderDiv);
		...
		if( checkInstanceSibDiv == null || checkInstanceSibDiv.length == 0 ) {		
			RoomUtils.createAppendHTMLEntity('div', 'form_inst_sibling_'  + key, 'form_inst_sibling', 'hidden', 'none', '',  instHolderDiv);
		...
		if( checkInstanceLinktoDiv == null || checkInstanceLinktoDiv.length == 0 ) {
			...
			RoomUtils.createAppendHTMLEntity('div', 'form_inst_linkto_'  + key, 'form_inst_linkto', 'hidden', 'none', '', instHolderDiv);			
		...
		if( checkInstanceConnecttoDiv == null || checkInstanceConnecttoDiv.length == 0 ) {		
			RoomUtils.createAppendHTMLEntity('div', 'form_inst_connectto_'  + key, 'form_inst_connectto', 'hidden', 'none', '',  instHolderDiv);
		...
		if( checkInstanceConnecttoDiv == null || checkInstanceConnecttoDiv.length == 0 ) {		
			RoomUtils.createAppendHTMLEntity('div', 'form_inst_edgeDetails_'  + key, 'form_inst_edgeDetails', 'hidden', 'none', '',  instHolderDiv);
...
//=====================================================================================================================================
	...
	RoomUtils.setDefault_ChildrenDiv = function ( key   ){
		if(!key){
			console.log(" no Room key provided: cannot build the create children table  "); 
			return;
		}
		...
		var checkInstanceChildDiv = $( "#form_inst_children_" + key );
	    	...
	    	text += "<td  class='create_icon' onclick='( new RoomManagerRender() ).addChildNodeForm(\"" + key + "\")'>";
		    text += "<img  id='img_create' title='Create New' src='"+img_path+ "design_icons/create.png'></td><td id='listTypeChildren_"+key+"'></td></tr></table>";		    
//		    var ableToAddNewChild = true;
//		    if (ableToAddNewChild == true) {
//		    	text += "<td  class='create_icon' onclick='( new RoomManagerRender() ).addChildNodeForm(\"" + key + "\")'>";
//			    text += "<img  id='img_create' title='Create New' src='"+img_path+ "design_icons/create.png'></td><td id='listTypeChildren_"+key+"'></td></tr></table>";
//		    } else {
//			    text += "<td></tr></table>";
//		    }
	...
	RoomUtils.setDefault_ParentDiv = function ( key   ){
		if(!key){
			console.log(" no Room key provided: cannot build the create Parent table  "); 
			return;
		}
		...
		var checkInstanceParDiv = $( "#form_inst_parent_" + key );
		    ...
		    text += "<td  class='create_icon' onclick='( new RoomManagerRender() ).addParNodeForm(\"" + key + "\")'>";
		    text += "<img  id='img_create' title='Create New' src='"+img_path+ "design_icons/create.png'></td><td id='listTypeParents_"+key+"'></td></tr></table>";
//		    var ableToAddNewParent = false;
//		    if (ableToAddNewParent == true) {
//			    text += "<td  class='create_icon' onclick='( new RoomManagerRender() ).addParNodeForm(\"" + key + "\")'>";
//			    text += "<img  id='img_create' title='Create New' src='"+img_path+ "design_icons/create.png'></td><td id='listTypeParents_"+key+"'></td></tr></table>";
//		    } else {
//			    text += "<td></tr></table>";
//		    }
	...
	RoomUtils.setDefault_SiblingDiv = function ( key   ){
		if(!key){
			console.log(" no Room key provided: cannot build the create Sibling table  "); 
			return;
		}
		...
		var checkInstanceSibDiv = $( "#form_inst_sibling_" + key );
		    ...
		    text += "<td  class='create_icon' onclick='( new RoomManagerRender() ).addSibNodeForm(\"" + key + "\")'>";
...
//		    var ableToAddNewSibling = false;
//		    if (ableToAddNewSibling == true) {
//			    text += "<td  class='create_icon' onclick='( new RoomManagerRender() ).addSibNodeForm(\"" + key + "\")'>";
//			    text += "<img  id='img_create' title='Create New' src='"+img_path+ "design_icons/create.png'></td><td id='listTypeSiblings_"+key+"'></td></tr></table><br />";
//		    } else {
//			    text += "<td></tr></table>";
//		    }
	...
	RoomUtils.setDefault_LinktoDiv = function ( key   ){
		if(!key){
			console.log(" no Room key provided: cannot build the Link To table  "); 
			return;
		}
	...
	RoomUtils.setDefault_ConnectToDiv = function ( key   ){
		if(!key){
			console.log(" no Room key provided: cannot build the Connect to table  "); 
			return;
		}
...
//====================================================================================================================================	
	...
	RoomUtils.saveRoomInfo = function ( currentType ){
		...
		// TODO: Should be decided by the data
		var missingSupportedRelatedNodes = false;
		historyNode.forEach(function ( element) {
			 ...
			 if( option == 'create' ) {
					...
					new RoomManagerRender().saveRoomCreated  (last.typeId, properties );
					if(!listInstUuids[0]){
				    ...
				    if (ele.value === "") {missingSupportedRelatedNodes = true;}
		...
		if (missingSupportedRelatedNodes == true) {
			return;
		}
		...
		new RoomManagerRender().saveRoomCreated (currentType, properties );
		...
		if(listInstUuids[0] != null) {( new RoomManagerRender() ).addRoomInst (listInstUuids[0]);	}	
		( new RoomManagerRender() ).selectedRoom( listInstUuids[0] );	
			
	}
		
//  Saving all edges at the end 
	RoomUtils.saveEdges = function( ){
		...
		createEdgeList.forEach(function ( element) {
			...
			if(element.status == 'pending'){                                // avoid all error records if any
				...
				if( element.typeIdcas == 'asParent' || element.typeIdcas == 'asSibling'){					
					   jsonData["originNodeUuid"]     =  element.nodeUuid;
					   jsonData["originType"]         =  element.typeId.toString() ;
					
					   jsonData["destinationNodeUuid"]= element.nodeUuidCurrType ;
					   jsonData["destinationType"]    = element.currTypeId.toString();
//					   jsonData["ruleName"]           = connMapViaId[element.typeConn].rule;
					   
					   
			    }else {
			    	   jsonData["originNodeUuid"]     =  element.nodeUuidCurrType;
			           jsonData["originType"]         =  element.currTypeId.toString() ;
			
					   jsonData["destinationNodeUuid"]= element.nodeUuid ;
					   jsonData["destinationType"]    = element.typeId.toString();
//					   jsonData["ruleName"]           = connMapViaId[element.typeConn].rule;
					...
					if(!$.isEmptyObject(dataEdge)){
						...
						NodeUtils.AddEdgeToMap( dataEdge);	
						 ...
						 if(element.typeIdcas == 'asParent' ){						 						 
							   ...
							   ( new RoomManagerRender() ).addNodeToParList(element.nodeUuidCurrType, element.nodeUuid, dataEdge);
							   

						 }else if ( element.typeIdcas == 'asChild'){
							 NodeUtils.buildChildNodeDetail (  element.nodeUuidCurrType, dataEdge);
							 ( new RoomManagerRender() ).addNodeToChildList( element.nodeUuidCurrType, element.nodeUuid, dataEdge);
							 
						 }else if ( element.typeIdcas == 'asSibling'){
							 NodeUtils.buildSiblingNodeDetail ( element.nodeUuidCurrType, dataEdge, 'destination');
							 ( new RoomManagerRender() ).addNodeToSibList(element.nodeUuidCurrType, element.nodeUuid, dataEdge);
						 }
	...
	RoomUtils.showEdgeDetails = function (key,  connId ){
		...
		currInput += "<input type='button' name='Cancel' value='Cancel'  onclick='RoomUtils.closeEdgeDetails(\""+key +"\")'></td</tr>";
		currInput += "</table>";
		$('#form_inst_edgeDetails_'+key ).append(currInput);
				
		RoomUtils.showDivision("form_inst_edgeDetails_", key );
		
	}
	
	RoomUtils.closeEdgeDetails = function( key ){
		
		RoomUtils.hideDivision("form_inst_edgeDetails_", key);
		
	}
	
	RoomUtils.addEdgeConn = function( keyOrigin ){
		...
		var doneFunction = function ( dataEdge ){
			...
			NodeUtils.AddEdgeToMap( dataEdge);	
			 ...
			 if(typeConnLink == 'asParent' ){
				 ...
				 ( new RoomManagerRender() ).addNodeToChildList(keyOrigin, eleInst, dataEdge);
			 }else {
				 NodeUtils.buildParentNodeDetail ( keyOrigin, dataEdge);
				 ( new RoomManagerRender() ).addNodeToParList(keyOrigin, eleInst, dataEdge);
			 }
			 RoomUtils.cancelConnectToInst(keyOrigin);		 
	...
	RoomUtils.addEdgeLink = function( keyOrigin ){
		...
		var doneFunction = function ( dataEdge ){
			...
			NodeUtils.AddEdgeToMap( dataEdge);	
			 ...
			 ( new RoomManagerRender() ).addNodeToSibList(keyOrigin, eleInst, dataEdge.type);
			
			 RoomUtils.cancelLinkToInst(keyOrigin);		
		}
...
//=========================================================================================================
	RoomUtils.buildTypeList = function ( nodeUuid, text ){
	...
	RoomUtils.buildTypeProperty =  function ( text,  combinedIds, nodeUuid){
		if(!nodeUuid){
		...
		var ableToBeCreatedHere = false;
		var restriction = NodeUtils.findRestriction (tmpType);
		if (  restriction  !== "ROOTONLY") {
			ableToBeCreatedHere = true;
		}
		
		if (ableToBeCreatedHere == true) {
			var inputCreate = '';
			...
			var addParent = document.getElementById('addChil_' + nodeUuid);
			var addChild = document.getElementById('addPar_' + nodeUuid);
			var addSibling = document.getElementById('addSib_' + nodeUuid);
			if (addParent) {
				addParent.style.display = '';
			}
			if (addChild) {
				addChild.style.display = '';
			}
			if (addSibling) {
				addSibling.style.display = '';
			}
...
//==============================================================================================================================	
	RoomUtils.buildTypeListConnect = function ( instId ){
		if(!instId){
		...
		// build the list of Types and append it 
		 if( valueSelected == 'asParent'){			 
			 ...
			 var inputTypeList =''; 
			 inputTypeList = '<td valign="middle" class="childType" ><select id="childType_'+instId+'" onchange="RoomUtils.buildTypeListInstanceConnect(\'child\',\''+ instId+'\');"><option value="">Select Children Type ...</option>';
			 if(listConnToChildren.length  >0 ){	
					...
					var  footer = '<td><input type="button"     value="Cancel" onclick="RoomUtils.cancelConnectToInst(\''+ instId+'\');" /></td>';
		 ...
		 if( valueSelected == 'asChild'){
			 ...
			 var tableInstConnDiv = $("#nodeFormConnecttoTable_" + instId );
			 var inputTypeList =''; 
			 inputTypeList = '<td valign="middle" class="parentType"><select id="parentType_'+instId+'"   onchange="RoomUtils.buildTypeListInstanceConnect(\'parent\',\''+ instId+'\');" ><option value="">Select Parent Type ...</option>';
	...
	RoomUtils.buildTypeListLink = function ( instId ){
		...
		var linkTo = document.getElementById('link_to_for_' + instId);
		if (linkTo && (linkTo.checked == true)) {
			var typeNodeId = nodeMap[instId].typeId;
			...
			$.each( connMapViaId, function( key, value ) {	
				...
				detailLink = {};
				 ...
				 var inputTypeList =''; 
				 inputTypeList = '<td valign="middle"><select id="linkType_'+instId+'"  onchange="RoomUtils.buildTypeListInstanceLink(\''+ instId+'\');"     ><option value="">Select Sibling Type ...</option>';
				 if(listLinks.length  != 0 ){			
						...
						var  footer = '<input type="button"     value="Cancel" onclick="RoomUtils.cancelLinkToInst(\''+ instId+'\');" /></td>';
						inputTypeList = inputTypeList + footer;
					}		
			...
			RoomUtils.cancelLinkToInst(instId);
		}
			 	
	}

	
    RoomUtils.buildTypeListInstanceConnect = function (text,  keyOrigin ){
		if(!keyOrigin){
			console.log("no Node uuid provided"+keyOrigin);
			return;
		}
		...
		var successFunction = function( data ) {
			...
			var parentNode = NodeUtils.isSubParent(Id[0], keyOrigin);
			 ...
			 var inputInstList =''; 
				if ( data.nodes.length  > 0 ){	
					...
					$.each(data.nodes, function(key, value){
						...
						var successFunctionP = function( dataP ) {
							if($.isEmptyObject(dataP.nodes)){      // at least the node itself is returned if it has no Parent/Children/Sibling
								console.log(" no Room details returned from the API get all related Nodes and edges");
							}else {
								console.log("data.nodes results are : ");
								console.table(dataP.nodes)
								console.log("data.edges are: ");
								console.table(dataP.edges);                            // data.edges may be empty if no Parent/Children/Sibling								
								NodeUtils.buildNodeDetails ( parentNode.uuid, dataP);
							}					
						};	
						...
						var nodeApiP = new NodeApis();			
						nodeApiP.getRelatedNodesEdges( Id[0]   ,parentNode.uuid, successFunctionP, failFunctionP);
					    
						if (parentNode) {
							if (NodeUtils.isChild(nodeMap[parentNode.uuid], uuid)) {
					...
					var footer  = '<td><input type="button"  value="Add"   onclick="RoomUtils.addEdgeConn(\''+ keyOrigin+'\')" />';
						footer += '<input type="button"     value="Cancel" onclick="RoomUtils.cancelConnectToInst(\''+ keyOrigin+'\');" /></td>';
					...
					inputInstLidt += '<td><input type="button" value="Cancel" onclick="RoomUtils.cancelConnectToInst(\''+ keyOrigin+'\');" /></td>';
    ...
    RoomUtils.buildTypeListInstanceLink = function (keyOrigin ){
		if(!keyOrigin){
			console.log("no Node uuid provided"+keyOrigin);
			return;
		}
			...
			console.log(data.nodes);
			 ...
			 var inputInstList =''; 
				if ( data.nodes.length  > 0 ){	
					...
					var footer  = '<td><input type="button"  value="Add"    onclick="RoomUtils.addEdgeLink(\''+ keyOrigin+'\')" />';
						footer += '<input type="button"      value="Cancel" onclick="RoomUtils.cancelLinkToInst(\''+ keyOrigin+'\');" /></td>';
					inputInstList = inputInstList + footer;
					...
					inputInstList += '<td> No node available;  change your selection  </td>';
					inputInstLidt += '<td><input type="button" value="Cancel" onclick="RoomUtils.cancelLinkToInst(\''+ keyOrigin+'\');" /></td>';
				}
		};
...
//=============================================================================================================================
    ...
    //
//============================================================================================================================
    RoomUtils.showCreateDiv = function (parent, typeId){
    	if(!typeId || !parent ){
...
//    		RoomUtils.addFormInstCreate($("#createParent_"+parent+"_for_"+typeId ), parent);
    		NodeUtils.addFormInstCreate($("#createParent_"+parent+"_for_"+typeId ), parent);
    		//  -- hide the select option 
    		RoomUtils.hideDivision('nodeDisplay_'+parent+'_for_', typeId);
    		// --  show the create option
    		RoomUtils.showDivision('createParent_'+parent+'_for_', typeId);
    		
    	}else if (valueSelected == 'use'){
    	
    		// build the list of nodes 
    		$("#nodeDisplay_"+parent+"_for_"+typeId).empty();;
    		RoomUtils.buildListNodes($("#nodeDisplay_"+parent+"_for_"+typeId), typeId, parent );
    		
    		// hide the create  option 
    		RoomUtils.hideDivision('createParent_'+parent+'_for_', typeId);
    		// show the list to select from 
    		RoomUtils.showDivision('nodeDisplay_'+parent+'_for_', typeId);	
    	}
    	       					    
    }
    
 // LOAD ALL NODES For PARENT TYPE SELECTED
    RoomUtils.buildListNodes = function(div,  typeId, typeParent ){                   // based on type selected load existing node Instances and display these
...
//*****************************************************************************
	RoomUtils.createRoom_cancel = function( typeId){
		if(!typeId){
    ...
    RoomUtils.updateRoom_cancel = function ( key ){	
		// hide Edit Form		
		RoomUtils.hideDivision ("form_inst_edit_", key  );	

		// show View Form
		RoomUtils.showDivision ("form_inst_", key  );	
		
	};	
	
	RoomUtils.cancelAddChild = function(){
	...
	RoomUtils.cancelAddSib = function(){
	...
	RoomUtils.cancelAddPar =function(){
	...
	RoomUtils.cancelLinkToInst = function ( instId ){		
		( new RoomManagerRender() ).displayLinkTo(instId);	
	}

	RoomUtils.cancelConnectToInst  = function ( instId ){	
		( new RoomManagerRender() ).displayConnectTo(instId);		
	}

//===============================================================================================================================	
	RoomUtils.clearAddRow = function(){
...
//===================================================================================================
	RoomUtils.showDivision = function ( divName, divId ){
	...
	RoomUtils.hideDivision = function ( divName, divId ){
