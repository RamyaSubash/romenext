...
//		typeMapViaId[type.id].cyDisplay = typeMapViaId[type.id].name;
//		typeMap[type.name].cyDisplay = typeMap[type.name].name;
//		typeMapViaId[type.id].color = TYPES_COLOR[colorIndex];
//		typeMap[type.name].color = TYPES_COLOR[colorIndex]; 
//		colorIndex++;
