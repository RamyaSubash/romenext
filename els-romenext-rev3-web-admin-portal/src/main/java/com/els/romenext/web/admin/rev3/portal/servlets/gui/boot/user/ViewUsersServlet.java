...
public class ViewUsersServlet extends HttpServlet {
	...
	private static Logger log = Logger.getLogger( ViewUsersServlet.class );
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		req.setAttribute("unknownUsers",  unknownUsers );

		req.getRequestDispatcher("/jsps/boot/users/view_users.jsp").forward(req, resp);
