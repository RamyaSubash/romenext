...
public class DynamicH2InMemoryDatabaseEMFactory extends NewBaseManagerFactory {

	private static Logger log = Logger.getLogger(DynamicH2InMemoryDatabaseEMFactory.class);

	private static NewBaseManagerFactory instance = new DynamicH2InMemoryDatabaseEMFactory();
	 ...
	 */
	public DynamicH2InMemoryDatabaseEMFactory() {

		this.namespace = "INMEMORY";

		try {
			Properties properties = new Properties();

			// default attempt to get the name, should we simply default this to a value?
			InputStream resourceAsStream = DynamicH2InMemoryDatabaseEMFactory.class.getResourceAsStream("/com/jpl/data/persistence.properties");
...
//			properties.put("javax.persistence.jdbc.url", "jdbc:mysql://localhost:3306/romenext" );
