...
public class H2InMemoryDatabaseEntityManagerFactory extends NewBaseManagerFactory {

	private static Logger log = Logger.getLogger(H2InMemoryDatabaseEntityManagerFactory.class);

	private static NewBaseManagerFactory instance = new H2InMemoryDatabaseEntityManagerFactory();
	 ...
	 */
	public H2InMemoryDatabaseEntityManagerFactory() {

		try {
			Properties properties = new Properties();

			// default attempt to get the name, should we simply default this to a value?
			InputStream resourceAsStream = H2InMemoryDatabaseEntityManagerFactory.class.getResourceAsStream("/com/els/data/persistence.properties");
