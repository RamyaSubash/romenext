...
public class GetNodesAndEdgesSimplifiedService {
	
	private static Logger log = Logger.getLogger(GetNodesAndEdgesSimplifiedService.class);
	
	private NodeCoreServices nodeCoreServices = null;
	private RelationshipCoreServices relationshipCoreServices = null;
	
	public GetNodesAndEdgesSimplifiedService () {

	}
	
	public GetNodesAndEdgesSimplifiedService (NodeCoreServices nodeCoreServices, RelationshipCoreServices relationshipCoreServices) {
		this.nodeCoreServices = nodeCoreServices;
		this.relationshipCoreServices = relationshipCoreServices;
	}
	
	public Response runService(GetNodesAndEdgesSimplifiedRequest req, Long metadata, String username) {
