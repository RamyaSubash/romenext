...
public class AddTypePropertiesService {
	
	private static Logger log = Logger.getLogger(AddTypePropertiesService.class);

	public Response runService( AddTypePropertiesRequest req, Long metadataId ) {
		...
		RomeType newRt = rtDao.get( req.getTypeId() );
