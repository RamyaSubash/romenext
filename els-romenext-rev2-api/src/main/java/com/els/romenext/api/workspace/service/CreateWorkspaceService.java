...
public class CreateWorkspaceService {
	...
	private static Logger log = Logger.getLogger(CreateWorkspaceService.class);
	...
	public CreateWorkspaceService (Neo4jNodeServices neo4jNodeServices, Neo4jWorkspaceServices workspaceServices ) {
		this.neo4jNodeServices = neo4jNodeServices;
		this.workspaceServices = workspaceServices;
	}
	
	public Response runService(CreateWorkspaceRequest req, Long repoId ) {
...
//		}
		...
		if( req.getNodes() != null && req.getNodes().size() > 0 ) {
			...
			this.workspaceServices.addNodesToWorkspaceNode(createdWorkspaceNode, toAddNodes, mrc);
