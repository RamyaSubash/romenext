 ...
 *
 */
public class GetPathByTypeRequest extends GroupRequest {
	
	private static Logger log = Logger.getLogger(GetPathByTypeRequest.class);
	...
	public String validateRequest(JSONObject json) {
		...
		String empty = RomeJSONUtils.findEmptyJson(json, "pathTypeId" );
		if (empty != null) {
			return empty;
		} 
